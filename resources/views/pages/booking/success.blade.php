    ...
    <div id="Background" class="absolute top-0 w-full h-[430px] rounded-b-[75px] bg-[linear-gradient(180deg,#F2F9E6_0%,#D2EDE4_100%)]"></div>
        <div class="relative flex flex-col gap-[30px] my-[60px] px-5">
            ...
            <div class="flex flex-col gap-[14px]">
                <a href="{{ route('home') }}" 
                   class="w-full rounded-full p-[14px_20px] text-center font-bold text-white bg-[#FF801A]">
                   Explore Other Kos
                </a>
                <form action="{{ route('check-booking.show') }}" method="POST">
                    ...
                    <div class="w-full rounded-full p-[14px_20px] text-center font-bold text-white bg-[rgb(7,7,7)]">
                        <button class="w-full">View My Booking</button>
                    </div>
                </form>
            </div>
        </div>
